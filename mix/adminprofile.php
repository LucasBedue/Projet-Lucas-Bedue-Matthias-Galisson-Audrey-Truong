...
<html lang="fr">
	<head>
		<title>Consultation de profil - Jeunes 6.4</title>
	...
	<body>
		<link type="text/css" rel="stylesheet" href="adminprofile.css" />
		...
		<div class="whole">			<!--	Container for the whole page	-->
			...
			<div class="bodybg">			<!--	Main body	-->
				...
				<div class="bottomcontainer">
					<div class="valid">
						<p>Supprimer cette expérience</p>
					</div>
					<div class="valid">
		...
		<script type="text/javascript">
            ...
            function createthebox(index,stateexp,nomj,prenomj,datej,reseauj,expj,dureej,iam1,iam2,iam3,iam4,nomref,prenomref,dateref,reseauref,expref,dureeref,commref,is1,is2,is3,is4){//function that create a box
							...
							var box4=document.createElement('div');//Young's information
                            box4.className='box4';
							...
							var box44=document.createElement('div');//Ref's Informations
            ...
            <?php  
                ...
                if(feof($f)){//If the file is empty
                  ...
                  rewind($f);
                    while(!feof($f)){
						//Get all the informations in "$tabvar" and call the function "createthebox()" with all these informations
